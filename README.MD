...
@source(type = 'live',newFieldToSourceAnnotation = 'FieldValue',sql.query = 'SELECT  ip,  timestamp, SUM(traffic)   FROM networkTrafficTable WHERE (traffic = 1000 AND traffic > 2000)',@map(type = 'json',enclosing.element = '$.properties',@attributes(ip = 'ip',timestamp = 'timestamp',traffic = 'traffic')))
