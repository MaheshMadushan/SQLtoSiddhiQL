...
public class LogSink implements ISink {
    ...
    public String getSiddhiAppCompositeAsString() {
        sinkAnnotation.append(sinkSignature.getAnnotationTypeSignature())
                .append("(").append("type = '").append(logSink.getSinkTypeSignature() + "'"); // @sink(type = "log",
        for (ISiddhiAppComposite annotationComposite : annotationComposites) {
            sinkAnnotation.append(",").append(annotationComposite);
        }
