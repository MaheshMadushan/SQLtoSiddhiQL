...
//                " FROM table WHERE col1 = 10 AND col2 = 20 XOR col3 = 30 AND col5 = 99");
        Statement statement = CCJSqlParserUtil.parse("SELECT  abcd@string, SUM(col1@int,clo3@int) AS a, COUNT(table.col2@int) AS b, col3@int AS c , table.col4@int as d, col5@int , col99@int " +
