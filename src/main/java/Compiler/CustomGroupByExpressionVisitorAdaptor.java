...
public class CustomGroupByExpressionVisitorAdaptor implements ExpressionVisitor {

    private final IEngine middleEngine;

    public CustomGroupByExpressionVisitorAdaptor(IEngine middleEngine) {
    ...
    public void visit(Column column) {
        middleEngine.handleGroupByExpressions(column);
